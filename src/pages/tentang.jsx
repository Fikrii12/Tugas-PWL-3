    ...
    <div className="d-flex justify-content-center align-item-center">
      <div className=" mt-4 text-white deks-tentang">
        <p>
          ...
          macam produk berkualitas tinggi. Kami menyediakan pilihan terbaik dari
          pakaian, sepatu, aksesoris, dan masih banyak lagi untuk memenuhi
          kebutuhan gaya Anda.
        </p>
        <p>
          Visi kami adalah memberikan pengalaman berbelanja yang menyenangkan
          dan aman bagi pelanggan kami. Dengan fokus pada kualitas dan kepuasan
          pelanggan, kami berkomitmen untuk memberikan produk-produk terbaik
          dengan harga yang terjangkau.
        </p>
        <p>
          Produk kami berasal dari berbagai merek terkemuka, sehingga Anda dapat
          yakin akan mendapatkan produk berkualitas tinggi setiap kali
